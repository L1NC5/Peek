/**
 * Object defining all set typologies
 */
export const ScryfallSetType = {
...
/**
 * Type defining all possible set typologies
 */
export type ScryfallSetType =
  (typeof ScryfallSetType)[keyof typeof ScryfallSetType]
